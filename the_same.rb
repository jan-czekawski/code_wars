...
# of 11, 14641 is the square of 121, 20736 the square of 144, 361 the square of 19, 25921 the square of 161, and so on. It gets obvious if we write b's elements in terms of squares:
...
# comp(a,b) returns false because in b 36100 is not
# the square of any number of a.

# Remarks

# a or b might be [] (all languages). a or b might
# be nil or null or None (except in Haskell, Elixir, C++, Rust).

# If a or b are nil (or null or None), the problem 
...
# The two arrays have the same size (> 0) given as
# parameter in function comp.
