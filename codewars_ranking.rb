...
# Any activities completed that are ranking 2 levels or more lower than
...
# Note: Codewars no longer uses this algorithm for its own
# ranking system. It uses a pure Math based solution that
# gives consistent results no matter what order a set of
